...
const Footer = () => {
  return (
    ...
    className='w-20 h-20'
    ></Image>
    <h1 className={`font-black text-2xl text-[#c3923c]`}>QurbaniHat</h1>
    <p>
     Your Qurbani, Our Commitment. <br /> Find healthy, certified animals <br /> for your blessed sacrifice this Eid ul-Adha.
    </p>
  </aside>
  <nav>
