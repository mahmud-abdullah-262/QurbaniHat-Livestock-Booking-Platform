...
>
  ...
  <FieldError />
      ...
      <div>
     <Link className="text-xs text-[#c3923c] font-bold" href={'/login'}>Login</Link> or <Link onClick={() => signInWithGoogle()} className="text-xs text-[#c3923c] font-bold" href={'#'}><Icon icon="devicon:google" /> Login with Google</Link>
        </div>
    </Form>
  );
};
